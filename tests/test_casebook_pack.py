"""Regression checks for the silver-rel-canary-yard casebook."""
...
from casebook.harness import assert_expected, silver_rel_canary_yard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(silver_rel_canary_yard_summary(), assert_expected())
